    ...
    def _CheckFormat(cls):
        if cls.FORMAT is None or not cls.FORMAT:
            raise NotImplementedError(
                "Subclasses of %s need to define FORMAT" % cls.__name__
            )
...
class EventRecord(GenericTimestampedRecord):
    ...
    @property
    def event_type(self):
        event_types = [None, "CARBS", "INSULIN", "HEALTH", "EXCERCISE", "MAX_VALUE"]
    ...
    def event_sub_type(self):
        subtypes = {
            ...
            "EXCERCISE": [None, "LIGHT", "MEDIUM", "HEAVY", "MAX_VALUE"],
        }
